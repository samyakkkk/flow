...
/** The profile folder, as the environment decided it before Electron was ready.
    Reading it here must stay synchronous: see `userDataPath` in DesktopEnvironment. */
