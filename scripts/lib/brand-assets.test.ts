...
describe("brand-assets", () => {
  ...
  it("uses the deployment icon for every release channel", () => {
    expect(BRAND_ASSET_PATHS.developmentDesktopIconPng).toBe("assets/brand/icon.png");
    expect(BRAND_ASSET_PATHS.nightlyMacIconPng).toBe("assets/brand/icon.png");
    expect(BRAND_ASSET_PATHS.productionMacIconPng).toBe("assets/brand/icon.png");
  });
});
